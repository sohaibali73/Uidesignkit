...
export function ReverseEngineerPage() {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      const researchText = cleanText(data.research || data.analysis || data.content || data.message || 'Strategy analysis completed.');
  ...
  const handleChatSend = async () => {
    ...
    try {
      ...
      const data = await response.json();
      const responseText = cleanText(data.research || data.analysis || data.content || data.message || 'I understand. Let me continue analyzing your strategy.');
  ...
  const handleSchematic = async () => {
    ...
    try {
      ...
      const data = await response.json();
      setSchematic(cleanText(data.schematic) || `STRATEGY ARCHITECTURE
...
RISK MANAGEMENT
  ...
  const handleCode = async () => {
    ...
    try {
      ...
      const data = await response.json();
      setGeneratedCode(data.code || `// AFL Strategy Code
